import { AnalyticsProvider, EventAttributes, EventMetrics, AnalyticsEvent, AutoTrackSessionOpts, AutoTrackPageViewOpts, AutoTrackEventOpts, PersonalizeAnalyticsEvent } from './types';
...
export declare class AnalyticsClass {
     ...
     * @param [provider] - name of the provider.
     */
    record(event: AnalyticsEvent | PersonalizeAnalyticsEvent, provider?: string): any;
    /**
     * Record one analytic event and send it to Pinpoint
